...
<section class="section grxg_form">
    <div class="mm_xg">
        <ul>
            <li class="mm_xg_hover" style="background: none;"><a href="<?php echo U('Withdraw/index');?>" style="color: #333;">提现申请</a></li>
            <li style="background: #85c125;"><a href="javascript:" style="color: #fff">提现记录</a></li>
        </ul>
    </div>
    <div>
        <div class="mm_xg_form">
            <table>
                ...
                <tbody>
                <?php if(is_array($withdraw)): foreach($withdraw as $key=>$val): ?><tr data-toggle="modal" data-target="#r<?php echo ($val["withdraw_id"]); ?>">
                    ...
                    <div class="container" id="mmdo">
                        <div class="modal fade" id="r<?php echo ($val["withdraw_id"]); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                ...
                                <span>
                                <?php if($val["state"] == 0 ): ?>审核中<?php elseif($val["state"] == 1 ): ?> 通过<?php else: ?>未通过<?php endif; ?>
                                </span>
                                        </h4>
                                    </div>
                                    <div class="modal-body">
                                        <form name="form" method="post" action="" style="display: block;" class="mm_xg_form">
                                            ...
                                            <div class="form-group">
                                                <label for="grxg_ID">收益积分：</label>
                                                <input type="text" class="form-control" readonly name="grxg_ID" placeholder="" value="<?php echo ($val["profit_integral"]); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="grxg_ID">冻结积分：</label>
                                                <input type="text" class="form-control" readonly name="grxg_ID" placeholder="" value="<?php echo ($val["freeze_integral"]); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="grxg_ID">提现银行：</label>
                                                <input type="text" class="form-control" readonly name="grxg_ID" placeholder="" value="<?php echo ($val["bank"]); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="grxg_ID">银行账号：</label>
                                                <input type="text" class="form-control" readonly name="grxg_ID" placeholder="" value="<?php echo ($val["bank_number"]); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="grxg_ID">提现金额：</label>
                                                <input type="number" class="form-control" readonly  name="Transfer_amount" placeholder="" value="<?php echo ($val["total"]); ?>">
                                            </div>
