...
<body id="body">
    ...
    <div class="sct_menu">
        <section class="section">
            <div class="Settlement_top">
                ...
                <ul class="fl">
                    <li>
                        代理商名称：<span class="stm_UName"><?php echo ($data["name"]); ?></span>
                        (
                        ...
                        <table class=" table-bordered table-hover text-center">
                            ...
                            <tbody class="Settlement_tbody">
                                <tr class="Settlement_tbody_fr">
                                    ...
                                    <td>￥<?php echo ($data["shoping_points"]); ?><a>查看明细<span class="caret"></span></a></td>
                                </tr>
                          <tr>
                                    <td colspan="5">
                                        <ul>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span>服务中心：￥<?php echo ($fwzxpay?$fwzxpay:'0'); ?></span>
                                                <span>购车返款：￥<?php echo ($gpay?$gpay:'0'); ?></span>
                                                <span>代理商返款：￥<?php echo ($dlspay?$dlspay:'0'); ?></span>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span>服务中心收益：￥<?php echo ($nofwzxpay?$nofwzxpay:'0'); ?></span>
        ...
        <ul class="section_content">
          ...
          <a href="__APP__/Core/fkmx/act/返款明细" >
            ...
            <li class="fwzx">
                ...
                <a href="<?php echo U('Service/User_fwzxsq');?>" >
                    <i class="glyphicon glyphicon-tasks"></i>
                    <span>服务中心申请</span>
                </a>
            </li>
        ...
        <ul class="section_content02">
            ...
            <li class="dls">
                <a href="<?php echo U('Agent/show_agent_back');?>">
   ...
   <input type="hidden" name="back_id" value="<?php echo ($_SESSION['id']); ?>">
    <script type="text/javascript">
        (function () {
        ...
        $(function(){
            var id=$("input[name='back_id']").val();
            $.post("<?php echo U('Agent/check_back');?>",{nid:id},function(e){
                if(e==1){
                    $("li.dls").find("a").attr("href","<?php echo U('Agent/show_back');?>");
                    $("li.dls").find("span").first().text("代理商返款记录");
                }else{
                    $("li.dls").find("a").attr("href","<?php echo U('Agent/show_agent_back');?>");
                    $("li.dls").find("span").first().text("代理商返款申请");
                }
            })
        });
        $(function(){
            var id=$("input[name='back_id']").val();
            $.post("<?php echo U('Service/check_info');?>",{nid:id},function(e){
                if(e==1){
                    $("li.fwzx").find("a").attr("href","<?php echo U('Service/show_service');?>");
                    $("li.fwzx").find("span").first().text("服务中心管理");
                }else{
                    $("li.fwzx").find("a").attr("href","<?php echo U('Service/index');?>");
                    $("li.fwzx").find("span").first().text("服务中心申请");
                }
            })
        })
    </script>
