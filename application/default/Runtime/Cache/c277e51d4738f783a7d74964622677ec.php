...
<section class="section">
    <form name="form" method="post" action="__APP__/Join/Join" class="join_form">
        <div class="form-group">
            ...
            <input type="text" class="form-control" readonly name="tjr_name"  placeholder="" value="<?php echo ($user["name"]); ?>">
        </div>
        <div class="form-group">
            <label for="tjr_ID">推荐人ID：</label>
            <input type="text" class="form-control" readonly name="tjr_ID" placeholder="" value="<?php echo ($user["userid"]); ?>">
        </div>
        <div class="form-group">
            <label class="control-label">当前可用现金积分：</label>
            <input type="text" class="form-control" name="yjr_dqxjjf" readonly placeholder="" value="<?php echo ($user["cash_points"]); ?>">
        </div>
        <div class="form-group">
